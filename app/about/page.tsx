  ...
  return (
    <div className='font-sans bg-gray-100 text-gray-800'>
      ...
      <section className='flex flex-col items-center justify-center text-center py-16 px-8 bg-gray-100'>
        <h1 className='text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-purple-500 bg-clip-text text-transparent'>
          About RestTrack
        </h1>
        <p className='text-lg md:text-xl bg-gradient-to-r from-violet-500 via-fuchsia-500 to-purple-500 bg-clip-text text-transparent'>
      ...
      <section className='py-16 px-8 bg-white'>
        ...
        <p className='text-gray-600 max-w-3xl mx-auto text-center'>
          at RestTrack, we aim to help individuals achieve better sleep and
      ...
      <section className='py-16 px-8 bg-white'>
        ...
        <p className='text-gray-600 max-w-3xl mx-auto text-center'>
          RestTrack was created to address the growing need for better sleep
      ...
      <section className='py-16 px-8 bg-gray-100 text-center'>
        ...
        <p className='text-lg mb-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent'>
          Join RestTrack today and take the first step towards better sleep
          and a healthier life.
        </p>
        <Link
          href='/sign-up'
          className='inline-block bg-white text-purple-600 hover:text-purple-700 hover:scale-105 px-6 py-3 rounded-md font-medium shadow-md transition'
        >
          Get Started
        </Link>
      </section>
